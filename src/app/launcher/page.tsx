...
const CATEGORIES = ["all", "deepspace", "planets", "guiding", "analysis", "drivers", "vendor", "utilities"]
...
export default function LauncherPage() {
  ...
  useEffect(() => {
    setCurrentPage(1)
  }, [searchQuery, currentTab, itemsPerPage, filterFeatured, filterInstalled, sortBy, sortDirection, setCurrentPage])
  ...
  }, [isInstalling, installProgress, updateInstallProgress, completeInstallation, selectedSoftware])
  ...
  const handleSoftwareAction = async (software: Software) => {
    if (software.actionLabel === "Install") {
      ...
      // Launch the software
      try {
        // In a real app, this would call a server action to launch the software
        ...
        toast({
          title: "Launch Failed",
          description: error instanceof Error ? error.message : 'Failed to launch software',
          variant: "destructive",
        })
      }
    }
  ...
  const handleRefresh = async () => {
    try {
      ...
      toast({
        ...
        description: "Failed to refresh software list.",
        variant: "destructive",
      })
    }
  }
        ...
        >
          <div className="px-4 border-b overflow-x-auto">
            <TabsList className="h-14 w-full justify-start">
              ...
              <TabsTrigger value="deepspace" className="data-[state=active]:border-b-2 data-[state=active]:border-primary">
                Deep Space
              </TabsTrigger>
              <TabsTrigger value="planets" className="data-[state=active]:border-b-2 data-[state=active]:border-primary">
                Planets
              </TabsTrigger>
              <TabsTrigger value="guiding" className="data-[state=active]:border-b-2 data-[state=active]:border-primary">
                Guiding
              </TabsTrigger>
              <TabsTrigger value="analysis" className="data-[state=active]:border-b-2 data-[state=active]:border-primary">
                Analysis
              </TabsTrigger>
              <TabsTrigger value="drivers" className="data-[state=active]:border-b-2 data-[state=active]:border-primary">
                Drivers
              </TabsTrigger>
              <TabsTrigger value="vendor" className="data-[state=active]:border-b-2 data-[state=active]:border-primary">
                Vendor
              </TabsTrigger>
              <TabsTrigger value="utilities" className="data-[state=active]:border-b-2 data-[state=active]:border-primary">
                Utilities
              </TabsTrigger>
            </TabsList>
          </div>
              ...
              <>
                ...
                <div className="grid gap-4 py-4">
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    ...
                    <div>{new Date(selectedSoftware.lastUpdated).toLocaleDateString()}</div>
                    ...
                    {selectedSoftware.dependencies && selectedSoftware.dependencies.length > 0 && (
                      <>
                    ...
                    {selectedSoftware.tags && selectedSoftware.tags.length > 0 && (
                      <>
                  ...
                  {isInstalling && selectedSoftware.actionLabel === "Install" && (
                ...
                <DialogFooter>
                  {selectedSoftware.website && (
                    <Button 
                      variant="outline" 
                      className="mr-auto"
                      onClick={() => window.open(selectedSoftware.website, '_blank')}
                    >
                      Visit Website
                    </Button>
                  )}
...
function SoftwareItem({ software, viewMode, onAction, onInfo }: SoftwareItemProps) {
    ...
    return (
      <div className="flex flex-col border rounded-lg overflow-hidden hover:shadow-md transition-shadow">
        <div className="p-4 flex items-center gap-3 border-b bg-muted/20">
          <Image src={software.icon || "/placeholder.svg"} alt={software.name} width={40} height={40} className="rounded" />
